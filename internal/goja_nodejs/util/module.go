...
import (
	...
	"github.com/maclof/goja-perf/internal/goja_nodejs/require"
)
...
func (u *Util) jsFormat(call goja.FunctionCall) goja.Value {
	...
	u.Format(&b, format, args...)

	return u.runtime.ToValue(b.String())
}

func Require(runtime *goja.Runtime, module *goja.Object) {
	u := &Util{runtime: runtime}
	obj := module.Get("exports").(*goja.Object)
	obj.Set("format", u.jsFormat)
}

func New(runtime *goja.Runtime) *Util {
	return &Util{runtime: runtime}
}
